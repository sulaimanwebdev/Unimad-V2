        ...
        <div className="flex flex-col h-full py-2">
         ...
         <div className="flex-1 flex items-center justify-center gap-5 flex-col w-full max-w-[850px] mx-auto pt-14">
          <div className="relative bg-[#F8F8F8] border border-[#8C8C8C] grid grid-cols-[1fr,1fr,1fr,1fr,1fr,1fr,1fr,1fr] gap-2 rounded-full w-full px-3 py-2">
            <div className="bg-[#D9D9D9] h-[32px] grid grid-cols-3 rounded-full divide-x divide-white"><div className="relative bg-main rounded-l-full"><img src="/images/triangle.svg" alt="triangle" className="absolute -top-[40px] left-1/2 -translate-x-1/2" draggable={false}/></div><div className="relative bg-main flex items-center justify-center"><img src="/images/tick.svg" alt="tick" draggable={false} /> <img src="/images/triangle.svg" alt="triangle" className="absolute -top-[40px] left-1/2 -translate-x-1/2" draggable={false}/></div><div className="relative bg-main rounded-r-full"><img src="/images/triangle.svg" alt="triangle" className="absolute -top-[40px] left-1/2 -translate-x-1/2" draggable={false}/></div></div>
            <div className="bg-[#D9D9D9] h-[32px] grid grid-cols-3 rounded-full divide-x divide-white"><div className="relative bg-main rounded-l-full"><img src="/images/triangle.svg" alt="triangle" className="absolute -top-[40px] left-1/2 -translate-x-1/2" draggable={false}/></div><div className="relative bg-main flex items-center justify-center"><img src="/images/tick.svg" alt="tick" draggable={false} /> <img src="/images/triangle.svg" alt="triangle" className="absolute -top-[40px] left-1/2 -translate-x-1/2" draggable={false}/></div><div className="relative bg-main rounded-r-full"><img src="/images/triangle.svg" alt="triangle" className="absolute -top-[40px] left-1/2 -translate-x-1/2" draggable={false}/></div></div>
            <div className="bg-[#D9D9D9] h-[32px] grid grid-cols-3 rounded-full divide-x divide-white"><div className="relative bg-main rounded-l-full"><img src="/images/triangle.svg" alt="triangle" className="absolute -top-[40px] left-1/2 -translate-x-1/2" draggable={false}/></div><div className="relative bg-main flex items-center justify-center"><img src="/images/tick.svg" alt="tick" draggable={false} /> <img src="/images/triangle.svg" alt="triangle" className="absolute -top-[40px] left-1/2 -translate-x-1/2" draggable={false}/></div><div className="relative bg-main rounded-r-full"><img src="/images/triangle.svg" alt="triangle" className="absolute -top-[40px] left-1/2 -translate-x-1/2" draggable={false}/></div></div>
            <div className="bg-[#D9D9D9] h-[32px] grid grid-cols-3 rounded-full divide-x divide-white"><div className="relative bg-main rounded-l-full"><img src="/images/triangle.svg" alt="triangle" className="absolute -top-[40px] left-1/2 -translate-x-1/2" draggable={false}/></div><div className="relative bg-main flex items-center justify-center"><img src="/images/tick.svg" alt="tick" draggable={false} /> <img src="/images/triangle.svg" alt="triangle" className="absolute -top-[40px] left-1/2 -translate-x-1/2" draggable={false}/></div><div className="relative bg-main rounded-r-full"><img src="/images/triangle.svg" alt="triangle" className="absolute -top-[40px] left-1/2 -translate-x-1/2" draggable={false}/></div></div>
            <div className="bg-[#D9D9D9] h-[32px] grid grid-cols-3 rounded-full divide-x divide-white"><div className="relative bg-main rounded-l-full"><img src="/images/triangle.svg" alt="triangle" className="absolute -top-[40px] left-1/2 -translate-x-1/2" draggable={false}/></div><div className="relative bg-main flex items-center justify-center"><img src="/images/tick.svg" alt="tick" draggable={false} /> <img src="/images/triangle.svg" alt="triangle" className="absolute -top-[40px] left-1/2 -translate-x-1/2" draggable={false}/></div><div className="relative bg-main rounded-r-full"><img src="/images/triangle.svg" alt="triangle" className="absolute -top-[40px] left-1/2 -translate-x-1/2" draggable={false}/></div></div>
